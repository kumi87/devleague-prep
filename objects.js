...
Each property declaration expression will be on its own line and ending with semicolons (;). 
This is just one way of adding properties to an object.
...
Declare a variable named stockCar and set its value to be an object 
with its key-value pairs separated by commas (,). 
This is a way of declaring a new object and also being able to add property names and values 
at the moment an object is created.
...
then store the return value. 
Use console.log three times to print the entire object, just the value at name, and just the value at age.
*/
...
var newPerson = buildPerson(plainPerson, "Kumiko", 20);
...
Add the these values and store the sum to this object's result property. 
This function will return the object.

Invoke your function and pass in your object, store the result to 
...
function additionWithAnObject (object){
	object.result = (object.a + object.b);
	return object; 
}

var newResult = additionWithAnObject(test);
...
the values of the object being passed in or create more objects and invoke your function multiple times.
*/

function printSum (object){
	test.output =　"'"　+object.a+ ' + ' +object.b+ ' + ' + ' = ' +object.result+　"'";
	 
    console.log(test.output);
    return object;
}

var rtnObject = printSum(test);
...
Declare a function and a single parameter which will be an object. 
Within this function, write a FOR loop that adds 10 random number values to 
the array referenced at the contents property of the object being passed in. 
This function will return the object.

Invoke your function and pass in your object (which should be plainBox), 
store the result to a variable and use console.log to inspect your results.*/


function puttingStuffInplainBox (object){
    
    object.contents = [];  //created new properties and stated that its an empty array.
                            // object.contents = object.contents // []; create property and array at same times
    for (var i = 0; i < 10; i++){
        object.contents.push(Math.floor(Math.random()*10)+1); //push the results to contents array property.
...
var plainBoxResult = puttingStuffInplainBox(plainBox);
...
Declare a function and a single parameter which will be an object. 
Within this function you will check to see if the car has an automatic or manual transmission 
...
Invoke your function and pass in your object, store the result to a variable and 
use console.log to inspect your results.**/


function transmission (transObject){
    if (transObject.automaticTransmission === true){
       console.log("It is automatic"); 
    }else{
...
the other will be a person. Within this function, set the driver value of the stockCar to 
the second parameter being passed into your function.

Invoke your function and pass in your objects, store the result, and inspect your results. 
Consider using plainPerson as your driver.**/


function setDriver (car, person){
...
/**he Dev League instructors want to ride your whip!

Declare a variable named passengerList and set it to be 
['Jon', 'Jason', 'Tony', 'Joe', 'Jesse', 'Nigel', 'Kelli', 'Marifel', 'Victor']

Declare a variable named passengerAges and set it to be [19, 12, 21, 22, 16, 9, 19, 20, 15]

Declare a function and three parameters. 
The first will be a car and the second will be an array of names and the third will be an array of ages. 
...
(remember that this function returns a new object). Don't forget that this function actually takes three arguments, 
how will you handle that? (you should not have to change your function).**/

var passengerList = ['Jon', 'Jason', 'Tony', 'Joe', 'Jesse', 'Nigel', 'Kelli', 'Marifel', 'Victor'];
var passengerAges = [19, 12, 21, 22, 16, 9, 19, 20, 15];

function weRiding (car, names, ages){
...
Delcare a function and set one parameter which will be a car. 
This function should print out each passenger's name and age one line at a time.
